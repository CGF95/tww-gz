...
enum ItemTable {
    /* 0x00 */ HEART_DROP = 0x00,
    /* 0x01 */ GREEN_RUPEE_DROP = 0x01,
    /* 0x02 */ BLUE_RUPEE_DROP = 0x02,
    /* 0x03 */ YELLOW_RUPEE_DROP = 0x03,
    /* 0x04 */ RED_RUPEE_DROP = 0x04,
    /* 0x05 */ PURPLE_RUPEE_DROP = 0x05,
    /* 0x06 */ ORANGE_RUPEE_DROP = 0x06,
    /* 0x07 */ HEART_PIECE = 0x07,
    /* 0x08 */ HEART_CONTAINER = 0x08,
    /* 0x09 */ SMALL_MAGIC_DROP = 0x09,
    /* 0x0A */ LARGE_MAGIC_DROP = 0x0A,
    /* 0x0B */ BOMB_DROP = 0x0B,
    /* 0x0F */ SILVER_RUPEE_DROP = 0x0F,
    /* 0x10 */ SINGLE_ARROW_DROP = 0x10,
    /* 0x11 */ DOUBLE_ARROW_DROP = 0x11,
    /* 0x12 */ TRIPLE_ARROW_DROP = 0x12,
    /* 0x15 */ KEY_DROP = 0x15,
    /* 0x16 */ FAIRY_DROP = 0x16,
    /* 0x1E */ TRIPLE_HEART_DROP = 0x1E,
    /* 0x1F */ JOY_PENDANT = 0x1F,
    /* 0x20 */ TELESCOPE = 0x20,
    /* 0x21 */ TINGLE_TUNER = 0x21,
    /* 0x22 */ WIND_WAKER = 0x22,
    /* 0x23 */ PICTO_BOX = 0x23,
    /* 0x24 */ SPOILS_BAG = 0x24,
    /* 0x25 */ GRAPPLING_HOOK = 0x25,
    /* 0x26 */ DELUXE_PICTO_BOX = 0x26,
    /* 0x27 */ BOW = 0x27,
    /* 0x28 */ POWER_BRACELETS = 0x28,
    /* 0x29 */ IRON_BOOTS = 0x29,
    /* 0x2A */ MAGIC_ARMOR = 0x2A,
    /* 0x2B */ WATER_BOOTS = 0x2B,
    /* 0x2C */ BAIT_BAG = 0x2C,
    /* 0x2D */ BOOMERANG = 0x2D,
    /* 0x2F */ HOOKSHOT = 0x2F,
    /* 0x30 */ DELIVERY_BAG = 0x30,
    /* 0x31 */ BOMBS = 0x31,
    /* 0x32 */ TUNIC = 0x32,
    /* 0x33 */ SKULL_HAMMER = 0x33,
    /* 0x34 */ DEKU_LEAF = 0x34,
    /* 0x35 */ BOW_WITH_FIRE_AND_ICE_ARROWS = 0x35,
    /* 0x36 */ BOW_WITH_LIGHT_ARROWS = 0x36,
    /* 0x38 */ HEROS_SWORD = 0x38,
    /* 0x39 */ UNCHARGED_MASTER_SWORD = 0x39,
    /* 0x3A */ HALF_CHARGED_MASTER_SWORD = 0x3A,
    /* 0x3B */ HEROS_SHIELD = 0x3B,
    /* 0x3C */ MIRROR_SHIELD = 0x3C,
    /* 0x3E */ FULLY_CHARGED_MASTER_SWORD = 0x3E,
    /* 0x42 */ PIRATES_CHARM = 0x42,
    /* 0x43 */ HEROS_CHARM = 0x43,
    /* 0x45 */ SKULL_NECKLACE = 0x45,
    /* 0x46 */ BOKO_BABA_SEED = 0x46,
    /* 0x47 */ GOLDEN_FEATHER = 0x47,
    /* 0x48 */ KNIGHTS_CREST = 0x48,
    /* 0x49 */ RED_CHU_JELLY = 0x49,
    /* 0x4A */ GREEN_CHU_JELLY = 0x4A,
    /* 0x4B */ BLUE_CHU_JELLY = 0x4B,
    /* 0x4C */ MAP = 0x4C,
    /* 0x4D */ COMPASS = 0x4D,
    /* 0x4E */ BIG_KEY = 0x4E,
    /* 0x50 */ EMPTY_BOTTLE = 0x50,
    /* 0x51 */ RED_POTION = 0x51,
    /* 0x52 */ GREEN_POTION = 0x52,
    /* 0x53 */ BLUE_POTION = 0x53,
    /* 0x54 */ ELIXIR_SOUP_HALF = 0x54,
    /* 0x55 */ ELIXIR_SOUP = 0x55,
    /* 0x56 */ WATER = 0x56,
    /* 0x57 */ FAIRY = 0x57,
    /* 0x58 */ FOREST_FIREFLY = 0x58,
    /* 0x59 */ FOREST_WATER = 0x59,
    /* 0x61 */ TRIFORCE_PIECE_1 = 0x61,
    /* 0x62 */ TRIFORCE_PIECE_2 = 0x62,
    /* 0x63 */ TRIFORCE_PIECE_3 = 0x63,
    /* 0x64 */ TRIFORCE_PIECE_4 = 0x64,
    /* 0x65 */ TRIFORCE_PIECE_5 = 0x65,
    /* 0x66 */ TRIFORCE_PIECE_6 = 0x66,
    /* 0x67 */ TRIFORCE_PIECE_7 = 0x67,
    /* 0x68 */ TRIFORCE_PIECE_8 = 0x68,
    /* 0x69 */ NAYRUS_PEARL = 0x69,
    /* 0x6A */ DINS_PEARL = 0x6A,
    /* 0x6B */ FARORES_PEARL = 0x6B,
    /* 0x78 */ SAIL = 0x78,
    /* 0x79 */ TRIFORCE_CHART = 0x79,
    /* 0x82 */ ALL_PURPOSE_BAIT = 0x82,
    /* 0x83 */ HYOI_PEAR = 0x83,
    /* 0x8C */ TOWN_FLOWER = 0x8C,
    /* 0x8D */ SEA_FLOWER = 0x8D,
    /* 0x8E */ EXOTIC_FLOWER = 0x8E,
    /* 0x8F */ HEROS_FLAG = 0x8F,
    /* 0x90 */ BIG_CATCH_FLAG = 0x90,
    /* 0x91 */ BIG_SALE_FLAG = 0x91,
    /* 0x92 */ PINWHEEL = 0x92,
    /* 0x93 */ SICKLE_MOON_FLAG = 0x93,
    /* 0x94 */ SKULL_TOWER_IDOL = 0x94,
    /* 0x95 */ FOUNTAIN_IDOL = 0x95,
    /* 0x96 */ POSTMAN_STATUE = 0x96,
    /* 0x97 */ SHOP_GURU_STATUE = 0x97,
    /* 0x98 */ FATHERS_LETTER = 0x98,
    /* 0x99 */ NOTE_TO_MOM = 0x99,
    /* 0x9A */ MAGGIES_LETTER = 0x9A,
    /* 0x9B */ MOBLINS_LETTER = 0x9B,
    /* 0x9C */ CABANA_DEED = 0x9C,
    /* 0x9D */ COMPLIMENTARY_ID = 0x9D,
    /* 0x9E */ FILL_UP_COUPON = 0x9E,
    /* 0xA3 */ GOLDEN_TINGLE_HEAD = 0xA3,
    /* 0xFF */ EMPTY = 0xFF,
};
