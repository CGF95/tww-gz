...
enum ItemTable {
    /* 0x00 */ HEART_DROP,
    /* 0x01 */ GREEN_RUPEE_DROP,
    /* 0x02 */ BLUE_RUPEE_DROP,
    /* 0x03 */ YELLOW_RUPEE_DROP,
    /* 0x04 */ RED_RUPEE_DROP,
    /* 0x05 */ PURPLE_RUPEE_DROP,
    /* 0x06 */ ORANGE_RUPEE_DROP,
    /* 0x07 */ HEART_PIECE,
    /* 0x08 */ HEART_CONTAINER,
    /* 0x09 */ SMALL_MAGIC_DROP,
    /* 0x0A */ LARGE_MAGIC_DROP,
    /* 0x0B */ BOMB_DROP,
    /* 0x0F */ SILVER_RUPEE_DROP = 0x0F,
    /* 0x10 */ SINGLE_ARROW_DROP,
    /* 0x11 */ DOUBLE_ARROW_DROP,
    /* 0x12 */ TRIPLE_ARROW_DROP,
    /* 0x15 */ KEY_DROP = 0x15,
    /* 0x16 */ FAIRY_DROP,
    ...
    /* 0x24 */ SPOILS_BAG,
    /* 0x25 */ GRAPPLING_HOOK,
    /* 0x26 */ DELUXE_PICTO_BOX,
    /* 0x27 */ BOW,
    /* 0x28 */ POWER_BRACELETS,
    /* 0x29 */ IRON_BOOTS,
    /* 0x2A */ MAGIC_ARMOR,
    /* 0x2B */ WATER_BOOTS,
    /* 0x2C */ BAIT_BAG,
    ...
    /* 0x33 */ SKULL_HAMMER,
    /* 0x34 */ DEKU_LEAF,
    /* 0x35 */ BOW_WITH_FIRE_AND_ICE_ARROWS,
    /* 0x36 */ BOW_WITH_LIGHT_ARROWS,
    /* 0x38 */ HEROS_SWORD = 0x38,
    /* 0x39 */ UNCHARGED_MASTER_SWORD,
    /* 0x3A */ HALF_CHARGED_MASTER_SWORD,
    /* 0x3B */ HEROS_SHIELD,
    /* 0x3C */ MIRROR_SHIELD,
    ...
    /* 0x62 */ TRIFORCE_PIECE_2,
    /* 0x63 */ TRIFORCE_PIECE_3,
    /* 0x64 */ TRIFORCE_PIECE_4,
    /* 0x65 */ TRIFORCE_PIECE_5,
    /* 0x66 */ TRIFORCE_PIECE_6,
    /* 0x67 */ TRIFORCE_PIECE_7,
    /* 0x68 */ TRIFORCE_PIECE_8,
    /* 0x69 */ NAYRUS_PEARL,
    /* 0x6A */ DINS_PEARL,
    /* 0x6B */ FARORES_PEARL,
    /* 0x78 */ SAIL = 0x78,
    ...
    /* 0x91 */ BIG_SALE_FLAG,
    /* 0x92 */ PINWHEEL,
    /* 0x93 */ SICKLE_MOON_FLAG,
    /* 0x94 */ SKULL_TOWER_IDOL,
    /* 0x95 */ FOUNTAIN_IDOL,
    /* 0x96 */ POSTMAN_STATUE,
    /* 0x97 */ SHOP_GURU_STATUE,
    /* 0x98 */ FATHERS_LETTER,
    /* 0x99 */ NOTE_TO_MOM,
    /* 0x9A */ MAGGIES_LETTER,
    /* 0x9B */ MOBLINS_LETTER,
    /* 0x9C */ CABANA_DEED,
    /* 0x9D */ COMPLIMENTARY_ID,
    /* 0x9E */ FILL_UP_COUPON,
